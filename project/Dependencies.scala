...
object Dependencies {
  ...
  object Libs {
    ...
    val embeddedPostgres  = "io.zonky.test" % "embedded-postgres" % V.embeddedPostgres
    ...
    val logbackEncoder    = "net.logstash.logback" % "logstash-logback-encoder" % V.logbackEncoder

    val sttpOpenapiModel  = "com.softwaremill.sttp.apispec" %% "openapi-model" % V.sttpOpenapiModel
    ...
    val tapirJsoniter     = "com.softwaremill.sttp.tapir" %% "tapir-jsoniter-scala" % V.tapir
    ...
    val tapirZioHttp      = "com.softwaremill.sttp.tapir" %% "tapir-zio-http-server" % V.tapir
